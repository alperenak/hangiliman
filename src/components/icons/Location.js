...
function SvgLocation(props) {
  return (
    <StyledSelectBoxesIcon width="1em" height="1em" viewBox="0 0 21 24" fill="none" {...props}>
      <mask id="location_svg__a" maskUnits="userSpaceOnUse" x={0} y={0} width={21} height={24}>
        <path fill="#fff" d="M0 .466h20.341v22.811H0z" />
      </mask>
      <g mask="url(#location_svg__a)" fillRule="evenodd" clipRule="evenodd" fill="#000">
        <path
          opacity={0.48}
